...
int main(int argc, char *argv[]) {
        ...
        printf("LOG_OUTPUT: Average for %d trials and READ_SIZE = %d: Read time average = %.3f microseconds, Throughput = %.3f GB/s\n", NUM_TRIALS, READ_SIZE, 1000000*(total/NUM_TRIALS), ((READ_SIZE/total)*(NUM_TRIALS/1000000000.0)));
